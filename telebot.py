import argparse
from telebot.db import init_db, bot_exists, set_selected_bot, list_all_bots
from telebot.process import start_bot, stop_bot, get_bot_pid_if_running
from telebot.template import apply_template, list_templates
from telebot.telegram_handler import start_telegram_bot
